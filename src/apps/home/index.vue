<template>
  <div class="home_box" >
    ...
    <p class="addTitle">巨金宝</p>
    <div class="home_bag">
      <img src="../../assets/home/banner-bag.png">
    </div>
    <div class="bag_box">
      <div class="home_head">
        <div class="home_post" >
          <div class="home_tu">
            ...
            <div class="home_content" v-if="orderStatus!=4">
              <p>借款金额（元）</p>
    ...
    <div class="home_main" v-if="orderStatus==6">
      <div class="top">
        <div>
          <span><img src="../../assets/home/time.png"></span>
          <span>待还金额{{parseFloat(borrowLimit).toFixed(2)}}元</span>
        </div>
        <div style="height:38px">
          <span></span>
          <span style="color:#F83106 ">已逾期</span>
        </div>
      </div>
      <div class="buttom">
        <button @click="clickRepayment">立即还款</button>
      </div>
    </div>
    <!-- 立即借款 -->
    <div
    ...
    >
      <div class="top">
        <div>
          <span><img src="../../assets/home/qixian.png"></span>
          <span>{{pTerm}}天</span>
        </div>
        <div>
          <span><img src="../../assets/home/time.png"></span>
          <span>起借金额{{parseFloat(minPayment).toFixed(2)}}元</span>
        </div>
      </div>
      <div class="buttom">
    ...
    <!--未通过-->
    <div class="home_main" v-if="orderStatus == 5">
      <div class="top">
        <div>
          <span><img src="../../assets/home/qixian.png"></span>
          <span>{{pTerm}}天</span>
